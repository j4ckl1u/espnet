...
datadir=/home/shujliu/iwsltData
...
train_dev1=dev2010_en
recog_set="dev2010_de tst2010_de tst2013_de tst2014_de tst2015_de"
recog_set1="dev2010 tst2010 tst2013 tst2014 tst2015"
eval_set=tst2018_de
eval_set1=tst2018_en
...
if [ ${stage} -le 2 ]; then
    ...
    # make json labels
    data2json_ctc.sh --feat ${feat_tr_dir}/feats.scp  data/${train_set1}_trim data/${train_set}_trim ${dict} > ${feat_tr_dir}/data.json
    data2json_ctc.sh --feat ${feat_dt_dir}/feats.scp data/${train_dev1}_trim data/${train_dev}_trim ${dict} > ${feat_dt_dir}/data.json
    for rtask in ${recog_set1}; do
        feat_recog_dir=${dumpdir}/${rtask}_de/delta${do_delta}
        data2json_ctc.sh --feat ${feat_recog_dir}/feats.scp data/${rtask}_en data/${rtask}_de ${dict} > ${feat_recog_dir}/data.json
    done
fi
